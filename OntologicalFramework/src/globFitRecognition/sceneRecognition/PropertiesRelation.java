...
public class PropertiesRelation {
	...
	public static final String[] PROPERTIES_NAMES_SYMMETRIC_PRIMITIVE = {"isParallelTo", "isPerpendicularTo", "isCoaxialWith", "isAlong_x", "isAlong_y", "isAlong_z", "isCoplanar_xy", "isCoplanar_xz", "isCoplanar_yz"};
	...
	public static final String[] PROPERTIES_NAMES_SCENE_SYMMETRIC_PRIMITIVE = { "hasSceneComponent_Parallel", "hasSceneComponent_Perpendicular", "hasSceneComponent_Coaxial", "hasSceneComponent_AlongX", "hasSceneComponent_AlongY", "hasSceneComponent_AlongZ", "hasSceneComponent_CoplanarXY", "hasSceneComponent_CoplanarXZ", "hasSceneComponent_CoplanarYZ"};
