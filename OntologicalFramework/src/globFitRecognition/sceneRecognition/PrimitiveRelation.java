...
public class PrimitiveRelation {
	...
	public String toString(){
		String preIndName = OWLLibrary.getOWLObjectName( this.preInd);
		String postIndName = OWLLibrary.getOWLObjectName( this.postInd);
		...
		String preInvIndName = OWLLibrary.getOWLObjectName( this.getInverse().getPreInd());
		String postInvIndName = OWLLibrary.getOWLObjectName( this.getInverse().getPostInd());
		...
		private OWLClass findPrimitiveClass( Set<OWLClass> classes){
			...
			for( OWLClass cl : classes){
				for( OWLClass clPrim : primitiveTypes){
					if( OWLLibrary.getOWLObjectName( cl).equals( OWLLibrary.getOWLObjectName( clPrim))){
						primitiveClass = cl;
						classFound = true;
						break;
					}
