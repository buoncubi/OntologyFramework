...
import ontologyFramework.OFErrorManagement.OFGUI.allInstancesGUI.ClassTableInstance.MyTableModel;
	...
	public AllinstancesRunner() {
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				...
				HashMap<String, OFDebugLogger> allLog;
				synchronized( allLog = OFDebugLogger.getAllInstances()){
	...
	public void run(){
		...
		while( loopFlag) {
			...
			try {
				...
				Thread.sleep( ClassExcange.getAllInstancesPeriod() - done);
