...
public class Task5Dethacer extends OFJobAbstract{

	private static OFDebugLogger logger = new OFDebugLogger(Task5Dethacer.class, true);
	...
	private static final String ITEM8_indName = "S_Item08";
	private static final String ITEM9_indName = "S_Item09";
	...
	private static final String ITEM8_className = "Item1";
	private static final String ITEM9_className = "Item2";
	...
	public  static final String RECOGNISED_indName = "Vs_CardWrotten";
	...
	static{
		indsName.add( ITEM8_indName); property.add( ITEM_dataProp); classes.add( ITEM8_className);
		indsName.add( ITEM9_indName); property.add( ITEM_dataProp); classes.add( ITEM9_className);
	...
	public static synchronized void setWindowsCount(Integer windowsCounter) {
		//synchronized( windowsCounter){
			Task5Dethacer.windowsCount = windowsCounter;
		//}
	}
