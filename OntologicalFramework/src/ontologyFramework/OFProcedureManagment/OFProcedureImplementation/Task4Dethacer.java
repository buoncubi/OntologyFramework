...
public class Task4Dethacer extends OFJobAbstract{

	private static OFDebugLogger logger = new OFDebugLogger(Task4Dethacer.class, true);
	...
	private static final String PHONE1_indName = "S_Phone01"; // sensor individual names
	private static final String abitantName = "Abitant1"; // individual (results)
	
	// task1Ontology class names
	public static final String ITEM_className = "Phone";
	...
	private static final String PHONE_dataProp = "hasPhoneValue";
	...
	public  static final String RECOGNISED_indName = "Vs_Called";
	...
	static{
		indsName.add( PHONE1_indName); property.add( PHONE_dataProp); classes.add( null);
	...
	private void manageTimeWindows(boolean dataImported, Long clock){
		if (dataImported) { // interesting data coming	
			...
			OWLAxiom axiom = taskOntoRef.setSubClassOf( EMptyTimeWindow_className,w.getClassName());
	...
	public static synchronized void setWindowsCount(Integer windowsCounter) {
		//synchronized( windowsCounter){
			Task4Dethacer.windowsCount = windowsCounter;
		//}
	}
