...
public class Task7Dethacer extends OFJobAbstract{

	private static OFDebugLogger logger = new OFDebugLogger(Task7Dethacer.class, true);
	...
	private static final String DOOR11_indName = "S_Door11"; // sensor individual names
	...
	public  static final String RECOGNISED_indName = "Vs_Cleaned";
	...
	public static synchronized void setWindowsCount(Integer windowsCounter) {
		//synchronized( windowsCounter){
			Task7Dethacer.windowsCount = windowsCounter;
		//}
	}
