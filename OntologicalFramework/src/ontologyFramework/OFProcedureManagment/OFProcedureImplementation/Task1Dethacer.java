...
public class Task1Dethacer extends OFJobAbstract{

	private static OFDebugLogger logger = new OFDebugLogger(Task1Dethacer.class, true);
	...
	public static Integer importingCount = 0;
	...
	private static final String DOOR7_indName = "S_Door07"; // sensor individual names
	private static final String ITEM4_indName = "S_Item04";
	private static final String ITEM6_indName = "S_Item06";
	private static final String ITEM7_indName = "S_Item07";
	...
	private static final String ITEM4_className = "Item1";
	private static final String ITEM6_className = "Item2";
	...
	public  static final String RECOGNISED_indName = "Vs_DispencerFilled";
	...
	static{
		indsName.add( DOOR7_indName); property.add( DOOR_dataProp); classes.add( null);
		indsName.add( ITEM4_indName); property.add( ITEM_dataProp); classes.add( ITEM4_className);
		indsName.add( ITEM6_indName); property.add( ITEM_dataProp); classes.add( ITEM6_className);
		indsName.add( ITEM7_indName); property.add( ITEM_dataProp); classes.add( ITEM6_className);
	...
	private void manageTimeWindows(boolean dataImported, Long clock){
		if (dataImported) { // interesting data coming	
			...
			Long placingTime = Long.valueOf(placingOntoRef
					.getOnlyDataPropertyB2Individual( abitantName ,
							TIME_dataProp).getLiteral());
	...
	public static synchronized void setWindowsCount(Integer windowsCounter) { 
		Task1Dethacer.windowsCount = windowsCounter;
	}
