...
public class Task8Dethacer extends OFJobAbstract{

	private static OFDebugLogger logger = new OFDebugLogger(Task8Dethacer.class, true);
	...
	private static final String DOOR12_indName = "S_Door12";
	private static final String MOTION03_indName = "S_Motion03";
	private static final String MOTION04_indName = "S_Motion04";
	private static final String MOTION05_indName = "S_Motion05";
	private static final String MOTION06_indName = "S_Motion06";
	private static final String MOTION07_indName = "S_Motion07";
	...
	private static final String PLACINGDESCRIMINAT_objProp = "isNearTo";
	private static final String PLACINGDESCRIMINAT_indName = "A_CorridorCloset";
	...
	public  static final String RECOGNISED_indName = "Vs_OutfitChosen";
	...
	static{
		indsName.add( DOOR12_indName); property.add( DOOR_dataProp); classes.add( null);
		indsName.add( MOTION03_indName); property.add( POSITION_dataProp); classes.add( null);
		indsName.add( MOTION04_indName); property.add( POSITION_dataProp); classes.add( null);
		indsName.add( MOTION05_indName); property.add( POSITION_dataProp); classes.add( null);
		indsName.add( MOTION06_indName); property.add( POSITION_dataProp); classes.add( null);
		indsName.add( MOTION07_indName); property.add( POSITION_dataProp); classes.add( null);
		indsName.add( MOTION08_indName); property.add( POSITION_dataProp); classes.add( null);
		indsName.add( MOTION09_indName); property.add( POSITION_dataProp); classes.add( null);
	...
	private void manageTimeWindows(boolean dataImported, Long clock){
		...
		Set<OWLNamedIndividual> inds = taskOntoRef.getObjectPropertyB2Individual(abitantName, PLACINGDESCRIMINAT_objProp);
		OWLNamedIndividual closet = taskOntoRef.getOWLIndividual(PLACINGDESCRIMINAT_indName);
		boolean nearToCloset = false;
		...
		if (dataImported) { // interesting data coming	
			...
			Long placingTime = Long.valueOf(placingOntoRef
					.getOnlyDataPropertyB2Individual( abitantName,TIME_dataProp).getLiteral());
	...
	public static synchronized void setWindowsCount(Integer windowsCounter) {
		//synchronized( windowsCounter){
			Task8Dethacer.windowsCount = windowsCounter;
		//}
	}
